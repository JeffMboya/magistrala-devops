...
![Version: 0.15.2](https://img.shields.io/badge/Version-0.15.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.15.1](https://img.shields.io/badge/AppVersion-0.15.1-informational?style=flat-square)
...
| postgresdb.primary.persistence.enabled | bool | `true` |  |
| postgresdb.primary.persistence.size | string | `"2Gi"` |  |
...
| postgresreader.httpPort | string | `"9009"` |  |
